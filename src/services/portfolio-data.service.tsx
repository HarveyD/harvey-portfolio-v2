  ...
  public static readonly projectList: IProject[] = [
    {
      ...
      description: {
        ...
        detailed:
          "A simple web app that provides real time updates to cryptocurrency prices using their respective mascots.A simple web app that provides real time updates to cryptocurrency prices using their respective mascots."
      },
    ...
    },
    {
      ...
      description: {
        ...
        detailed:
          "A rebuild of the Bruce Hall VR project written in React. NOT LIVE. A rebuild of the Bruce Hall VR project written in React. NOT LIVE."
      },
